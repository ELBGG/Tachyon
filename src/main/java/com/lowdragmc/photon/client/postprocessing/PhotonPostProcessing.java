...
//                PhotonShaders.getBloomAddPassShader() : PhotonShaders.getBloomScatterPassShader();
        ...
        brightPassShader.safeGetUniform("Threshold").set((float) 1.0f);
...
//        var bloomIntensity = 1.0f.get().floatValue();
...
//        }
        ...
        finalCombinePassShader.safeGetUniform("BloomIntensive").set((float) 1.0f);
