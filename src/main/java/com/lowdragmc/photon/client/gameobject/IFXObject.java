...
public interface IFXObject extends IPersistedSerializable, com.lowdragmc.lowdraglib2.core.scene.ISceneObject, ILDLRegisterClient<IFXObject, Supplier<IFXObject>> {
    ...
    /** Returns the UUID of this object's transform (used as a map key in FXRuntime). */
    default java.util.UUID id() {
        return transform().id();
    }

    /** Called every tick to update game-logic state. */
