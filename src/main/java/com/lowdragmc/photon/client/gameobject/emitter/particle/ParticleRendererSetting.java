...
public class ParticleRendererSetting extends RendererSetting implements IPersistedSerializable {
    ...
    public Mode getRenderMode() { return renderMode; }

    public boolean isShade() { return shade; }

    public boolean isUseBlockUV() { return useBlockUV; }
}
