...
public class TrailsSetting implements com.lowdragmc.lowdraglib2.syncdata.IPersistedSerializable {
...
//                trail.setDelay(particle.getDelay() + trail.getDelay());
    ...
    public CompoundTag serializeNBT(HolderLookup.@NotNull Provider provider) {
        var data = com.lowdragmc.lowdraglib2.syncdata.IPersistedSerializable.super.serializeNBT(provider);
    ...
    public void deserializeNBT(HolderLookup.@NotNull Provider provider, @NotNull CompoundTag tag) {
        com.lowdragmc.lowdraglib2.syncdata.IPersistedSerializable.super.deserializeNBT(provider, tag);
