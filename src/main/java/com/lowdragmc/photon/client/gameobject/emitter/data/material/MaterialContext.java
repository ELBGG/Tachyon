...
public class MaterialContext {
    ...
    public MaterialContext setShaderDefine(String shaderDefine) { this.shaderDefine = shaderDefine; return this; }
    public String getShaderDefine() { return shaderDefine; }
    public MaterialContext setRenderingPreview(boolean isRenderingPreview) { this.isRenderingPreview = isRenderingPreview; return this; }
    public boolean isRenderingPreview() { return isRenderingPreview; }
}
